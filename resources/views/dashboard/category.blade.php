  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <button class="btn btn-md btn-primary" data-toggle="modal" data-target="#modal-lg"><i class="fas fa-plus"></i> Add Category</button>
          <div class="modal fade" id="modal-lg">
            <div class="modal-dialog modal-lg">
              <form id="quickForm" action="{{ route('category') }}" method="post">
                @method('POST')
                @csrf
          ...
          <table id="example2" class="table table-bordered table-hover nowrap">
            <thead>
            <tr>
              <th>No</th>
              <th>Category Name</th>
            ...
            <tbody>
              @foreach ($categorys as $category)
                <tr>
                  ...
                  <td>
                      <a href="/category/edit/{{ $category->id }}" class="btn btn-warning text-light btn-sm"><i class="fas fa-edit"></i></a> <a href="/category/destroy/{{ $category->id }}" class="btn btn-sm btn-danger text-light"><i class="fas fa-trash"></i></a>  
                  </td>
                </tr>
              @endforeach
            </tbody>
...
<script>
  $(function () {
    $('#quickForm').validate({
      ...
      messages: {
        is_publish: {
          required: "Please choice an option",          
        },
        category_name: {
