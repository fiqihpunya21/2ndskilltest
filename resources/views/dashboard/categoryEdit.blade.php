  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <a href="{{ '/category' }}" class="btn btn-md btn-success"><i class="fas fa-angle-double-left"></i> Back</a>
          
          <form id="quickForm" method="post" action="/category/update">
            @csrf
            @foreach ($category as $category)
            <div class="card-body">
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Category Name</label>
                <input type="text" name="category_name" class="form-control" id="inputEmail3" value="{{ $category->name }}">
                <input type="hidden" name="id" value="{{ $category->id }}">
              </div>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Is Publish</label>
