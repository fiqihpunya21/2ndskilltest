  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <button class="btn btn-md btn-primary" data-toggle="modal" data-target="#modal-lg"><i class="fas fa-plus"></i> Add User</button>
          <div class="modal fade" id="modal-lg">
            <div class="modal-dialog modal-lg">
              <form id="quickForm" action="{{ route('user') }}" method="post">
                @method('POST')
                @csrf
                ...
                <tr>
                  ...
                  <td>
                    ...
                    if($user->email != auth()->user()->email){
                      ?>
                      <a href="/user/edit/{{ $user->id }}" class="btn btn-warning text-light btn-sm"><i class="fas fa-edit"></i></a> <a href="/user/destroy/{{ $user->id }}" class="btn btn-sm btn-danger text-light"><i class="fas fa-trash"></i></a>
                      <?php
                    }  
                    ?>
                  </td>
